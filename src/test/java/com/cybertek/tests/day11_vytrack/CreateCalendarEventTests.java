...
public class CreateCalendarEventTests {
    ...
    public void verifyCancelButton() {
        ...
        driver.findElement(By.cssSelector(createCalendarEventButtonLocator)).submit();
        SeleniumUtils.waitPlease(5);
    ...
    public void verifyStartDateAndTime(){
        ...
        driver.findElement(By.cssSelector(createCalendarEventButtonLocator)).click();
        SeleniumUtils.waitPlease(5);
        String expectedDate = LocalDateTime.now().format(DateTimeFormatter.BASIC_ISO_DATE.ofPattern("MMM d, yyy"));
